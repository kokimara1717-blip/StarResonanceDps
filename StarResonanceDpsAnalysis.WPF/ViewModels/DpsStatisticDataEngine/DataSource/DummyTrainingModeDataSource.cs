...
namespace StarResonanceDpsAnalysis.WPF.ViewModels.DpsStatisticDataEngine.DataSource
{
        ...
        : IDpsDataSource
    {
        ...
        private readonly StatisticsContext _context = new StatisticsContext();
        private readonly TrainingDamageCalculator _damageCalculator = new TrainingDamageCalculator();
        private readonly Dictionary<long, PlayerStatistics> _rawCache = new Dictionary<long, PlayerStatistics>();
